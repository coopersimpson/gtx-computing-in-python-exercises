...
def stars(dict_movies, dict_tvshows):
    # Create list of actors
    list_actors = []
    for list in dict_movies.values():
        for item in list:
            if item not in list_actors:
                list_actors.append(item)
    for list in dict_tvshows.values():
        for item in list:
            if item not in list_actors:
                list_actors.append(item)
    ...
    # Add tv shows to dict
    for (key, value) in dict_movies.items():
        for item in value:
            if item in output_dict:
                output_dict[item].append(key)
    for (key, value) in dict_tvshows.items():
        for item in value:
            if item in output_dict:
                output_dict[item].append(key)

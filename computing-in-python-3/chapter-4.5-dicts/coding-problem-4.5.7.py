...
def course_info(list_of_tuples):
    ...
    # construct lists of students and ages
    for tuple in list_of_tuples:
        list_students.append(tuple[0])
        list_ages.append(tuple[1])
    
    # calculate avg age
    sum = 0
    for age in list_ages:
        sum += age
    avg_age = sum / len(list_ages)

    # construct dictionary
    output_dict = {"avg_age" : avg_age, "students" : list_students}
    return output_dict

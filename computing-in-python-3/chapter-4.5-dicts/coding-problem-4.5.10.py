...
def calculate_score(student_answers, correct_answers):
    # Check if belongs to same test
    length_student_answers = len(student_answers)
    length_correct_answers = len(correct_answers)
    if length_correct_answers != length_student_answers:
        return -1
